...
use sikulix_core::{PythonVersion, SyntaxAnalyzer};
use std::fs;
...
fn main() {
    ...
    info!("Core library version: {}", sikulix_core::VERSION);
...
fn get_core_version() -> String {
    debug!("Core version requested: {}", sikulix_core::VERSION);
    sikulix_core::VERSION.to_string()
}
